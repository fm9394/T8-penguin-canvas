...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.6.4
>
...
![status](https://img.shields.io/badge/version-v1.6.4-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🧍 **肖像大师**：工具箱新增捏人 Prompt 设计器，内置 9 大类百项级词库，支持不选、随机、锁定、权重、自定义补充、Avatar 分层方向预览和一键输出文本

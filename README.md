...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.5.4
>
...
![status](https://img.shields.io/badge/version-v1.5.4-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🧾 **文本分割二版**：文本分割节点支持段落 / 行 / 自定义分隔 / Markdown / 序号 / 智能分镜 / 正则高级 / 字数切块，内置模式说明、中文输入稳定编辑、双列预览布局、分段收藏、JSON 导入导出，并一键创建前置文本循环器链路；循环器执行完成后可自动打散为多个文本节点
...
- 🌗 **主题模板系统**：科技风 / 像素糖果风 / OP 风格 / RH 风格四套内置模板，支持浅色 / 深色、导入导出、编辑保存、自定义路径与默认静音主题音乐
...
产物：`dist_electron/T8-PenguinCanvas-Setup-<version>.exe`（v1.5.4 安装包约 104.65 MB）
...
| 样式 | Tailwind CSS 3 · CSS Modules · 主题模板（科技风 / 像素糖果风 / OP 风格 / RH 风格） |

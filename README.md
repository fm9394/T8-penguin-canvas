...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.4.4
>
...
![status](https://img.shields.io/badge/version-v1.4.4-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- ✂️ **宫格剪裁去缝预览**：独立宫格剪裁节点支持 gap 去缝、常用宫格预设，并在节点内直接预览切线与被裁掉的缝隙区域
...
产物：`dist_electron/T8-PenguinCanvas-Setup-<version>.exe`（v1.4.4 打包后以实际产物大小为准）
